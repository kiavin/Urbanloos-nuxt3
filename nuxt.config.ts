...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      title:
        "Urbanloos | Mobile Toilet Rentals in Kenya - Events & Construction Sites",
      htmlAttrs: {
        lang: "en-KE",
      },
      meta: [
        ...
        },
        {
          name: "description",
          content:
            "Clean, affordable mobile toilet rentals across Nakuru, Kiambu, Narok, Nyandarua, Laikipia. Book VIP or standard toilets for events, weddings, construction sites.",
        },
        {
          name: "viewport",
        ...
        },
        {
          name: "keywords",
          content:
            "mobile toilets kenya, toilet rentals nakuru, vip toilets kiambu, construction toilets narok, event sanitation kenya",
        },
        {
          property: "og:title",
        ...
        },
        {
          ...
          content:
            "Professional mobile toilet solutions for events, construction sites & emergencies. Serving Central & Rift Valley regions.",
        },
        {
          property: "og:type",
          content: "website",
        ...
        },
        {
          ...
          content:
            "Hygienic toilet rentals for construction, events & emergencies. Quick delivery in Nakuru, Kiambu & Narok.",
        },
        {
          name: "twitter:image",
