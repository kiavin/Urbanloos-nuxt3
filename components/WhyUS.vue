<template>
  <div class="bg-white">
    <section
      id="features"
      class="relative block px-6 py-10 md:py-20 md:px-10 bg-gray-50"
    >
      <div class="relative mx-auto max-w-5xl text-center">
        <span
          class="text-gray-900 my-3 flex items-center justify-center font-medium uppercase tracking-wider"
        >
          Why choose us
        </span>
        <h2 class="block w-full font-bold text-gray-900 text-3xl sm:text-4xl">
      ...
      >
        <div class="rounded-md bg-gray-100 p-8 text-center shadow">
          <div
          ...
          <h3 class="mt-6 text-gray-900">Customizable</h3>
          <p
            class="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-900"
          >
        ...
        <div class="rounded-md bg-gray-100 p-8 text-center shadow">
          ...
          <h3 class="mt-6 text-gray-900">Fast Performance</h3>
          <p
            class="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-900"
          >
        ...
        <div class="rounded-md bg-gray-100 p-8 text-center shadow">
          ...
          <h3 class="mt-6 text-gray-900">Fully Featured</h3>
          <p
            class="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-900"
          >
