<template>
  <footer class="bg-gray-50 pt-16 pb-10">
    <div class="px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="grid gap-12 row-gap-8 mb-12 sm:grid-cols-2 lg:grid-cols-4">
        <!-- Brand Column -->
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              <a href="#" class="text-gray-600 hover:text-pink-500 transition-colors duration-300 flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mt-0.5 mr-2 text-pink-400" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div>
          ...
          <div class="space-y-4">
            <div class="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-pink-500 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <div>
                <p class="text-gray-600">+254 715 557 481</p>
            ...
            <div class="flex items-start">
              ...
              <p class="text-gray-600">customerservice@urbanloos.com</p>
            </div>
            <div class="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-pink-500 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p class="text-gray-600">Kenyatta Ave, Naivasha<br>Above UrbanDining Hotel</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-600 text-sm mb-4 md:mb-0">
          © 2025 UrbanLoos. All rights reserved.
        </p>
